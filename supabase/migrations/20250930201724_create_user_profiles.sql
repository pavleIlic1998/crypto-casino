/*
  ...
  1. New Tables
    - `user_profiles`
      ...
      - `language` (text, not null) - Preferred language code (e.g., 'en', 'es')
  ...
  3. Important Notes
    - The `id` field links to Supabase auth.users(id)
    - Balance is stored as numeric(20,2) for precise decimal handling
    - Username and email must be unique across all users
    - Date of birth is required for age verification in casino context
*/
